...
> This library is a fork of [`ng2-pdf-viewer`](https://github.com/VadimDez/ng2-pdf-viewer)
> published as `@dasch-ng/pdf-viewer`. Pre-fork entries below were authored by the upstream
> maintainers; full git history is preserved in this monorepo.

## 11.0.0-rc.0 - 2026-05-21

- Fork of `ng2-pdf-viewer` starting from [VadimDez/ng2-pdf-viewer#1228](https://github.com/VadimDez/ng2-pdf-viewer/pull/1228) (Angular 21 + signals + zoneless + pdfjs-dist 5)
- Repackaged as `@dasch-ng/pdf-viewer`
- Migrated unit tests from Karma/Jasmine to Vitest (`@nx/angular:unit-test` executor)
- Pinned `pdfjs-dist` to `5.6.205`
- Original component selector `pdf-viewer` retained for drop-in compatibility
...
- [[#1149](https://github.com/VadimDez/ng2-pdf-viewer/pull/1149)] - Chore: update pdfjs, other dependencies
